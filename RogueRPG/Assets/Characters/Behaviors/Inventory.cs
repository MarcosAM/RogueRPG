...
public class Inventory : MonoBehaviour, IWaitForEquipment
{
    ...
    public void StartTurn()
    {
        ...
        {
            Equip equip = character.getUsableEquips()[Random.Range(0,character.getUsableEquips().Count)];
            equip.UseEquipmentOn(character,equip.GetBestTarget(character),this);
        }
    }
